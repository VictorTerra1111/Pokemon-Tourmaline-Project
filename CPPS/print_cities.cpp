...
bool print_rosyan()
{
    ...
    do
    {
        ...
        else if (input.empty())
        {
            ...
            {
            case 0:
                cout << "Going to Pokecenter...\n";
                break;
            case 1:
                cout << "Entering Shop...\n";
                break;
            case 2:
                cout << "Entering Maple's LAB...\n";
                break;
            case 3:
                cout << "Entering My house...\n";
                break;
            case 4:
                cout << "Entering Enemy's house...\n";
                break;
            case 5:
                cout << "Entering Dust's house...\n";
                break;
            case 6:
                cout << "Entering City's gate...\n";
                break;
            }
            return true;
        }
    ...
    do
    {
        ...
        else if (input.empty())
        {
            ...
            case 1:
                ...
                break;
            case 2:
                cout << "Entering Pokemon Gym...\n";
                break;
            case 3:
                cout << "Entering " << location1 << "...\n";
                break;
            case 4:
                cout << "Entering " << location2 << "...\n";
                break;
            case 5:
                cout << "Entering " << location3 << "...\n";
                break;
            case 6:
                cout << "Entering City's gate...\n";
                break;
...
bool print_factory()
{
    ...
    do
    {
        ...
        else if (input.empty())
        {
            ...
            {
            case 0:
                cout << "Going to Hospital...\n";
                break;
            case 1:
                cout << "Entering Shop...\n";
                break;
            case 2:
                cout << "Cmdoaj12*#d 0-sdj19?4tD#...\n";
                break;
            case 3:
                cout << "Walking to Atomic grunt...\n";
                break;
            case 4:
                cout << "Entering Old Room...\n";
                break;
            case 5:
                cout << "Entering Cemitery...\n";
                break;
            case 6:
                cout << "You left the factory...\n";
                break;
            }
            return true;
        }
